...
const createDriver = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (existingDriver) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "Driver profile already exists");
    }
    const driver = yield driver_model_1.Driver.create(payload);
    return driver;
});
const updateDriverStatus = (driverId, status) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllDrivers = () => __awaiter(void 0, void 0, void 0, function* () {
    const drivers = yield driver_model_1.Driver.find().populate("userId", "-password");
    return drivers;
});
